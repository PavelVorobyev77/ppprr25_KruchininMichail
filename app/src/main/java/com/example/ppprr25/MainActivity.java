...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton duckImageButton = findViewById(R.id.image_dock);
    ...
    View.OnClickListener onClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            int viewId = v.getId();
            if (viewId == R.id.image_cow) {
                playSound(mCowSound);
            } else if (viewId == R.id.image_chicken) {
                playSound(mChickenSound);
            } else if (viewId == R.id.image_cat) {
                playSound(mCatSound);
            } else if (viewId == R.id.image_dock) {
                playSound(mDuckSound);
            } else if (viewId == R.id.image_sheep) {
                playSound(mSheepSound);
            } else if (viewId == R.id.image_dog) {
                playSound(mDogSound);
            }
        }
    };
